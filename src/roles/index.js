...
const dialogue = {
    ...
    'dialogue1': {
        'anyRloe': {
            'moving': ['让我们动起来！', 'GPS不太准啊！', '这游戏没车子吗？', '为什么我不能跳着走？', '按住shift加速！', '一步两步~一步两步~', '作者连路都建不好！', '我没腿还能走，悬浮？'],
            'working': ['还在加班...', '*狗喘息*', '每天工作都不带变的！', '搏一搏，单车变摩托！',],
            'resting': ['偷个懒应该没人发现~', '*打哈欠*', '*吹口哨*', 'ZZZ~~~', '三点几嚟，饮茶先啦！', '不用干活针不戳~',],
            'any': ['原来我是NPC！？', '我感觉今天战无不胜!', '你的妈妈呢？', '这里到处都是1和0', '我好像没说过11个字', '我感觉记忆有点乱'],
            'hurt': ['医疗兵！', '卫生员！', '啊，我需要医疗兵！', '救我狗命！', '我还能被抢救一下！', '我胳膊要没了！', '我头在否！？', '帮我打个120！', '这算是工伤吧！？'],
            'hostile': ['警报！', '艾玛！', '见鬼！', '哎哟！', '天哪！我被盯上了！', '迎面走来的是...？', '你怎么走到这的？'],
        },
    },
    // 通用双人对话包（双方在三格范围内）
    // 部分骚话来自小兵步枪修改而来
